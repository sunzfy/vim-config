...
"Set font
if has("gui_gtk2")
  set gfn=Luxi\ Mono\ 14,Courier\ New\ 14,Courier\ 14,
          \DejaVu\ Sans\ Mono\ 14,Bitstream\ Vera\ Sans\ Mono\ 14,
          \SimSun\ 14,WenQuanYi\ Micro\ Hei\ Mono\ 14
elseif has("x11")
  set gfn=*-*-medium-r-normal--14-*-*-*-*-m-*-*
endif
...
if !exists("g:vimrc_loaded")
    ...
    if has("gui_running")
        ...
        set guioptions-=L
        set guioptions-=r
        colorscheme darkblue_sun
        hi normal guibg=#294d4a
        set cursorline
    else
        "colorscheme darkblue_sun
        "colorscheme desert_sun
        "colorscheme murphy_sun
...
function! CurDir()
  let curdir = substitute(getcwd(), '/home/andy/', "~/", "g")
  return curdir
endfunction
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
   ...
   let g:bufExplorerMaxHeight=45        " Max height
